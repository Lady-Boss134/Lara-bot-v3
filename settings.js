...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "HFInmarL#YI33qtexuzyh4wEKXq3MLKO7y_9KtIulG53iwVfo_4s", // Add your session id
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === : process.env.DELETEMSGSENDTO || "true",
